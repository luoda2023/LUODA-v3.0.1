...
$env:PATH = "J:\codex-work\.toolchains\jdk\jdk-17.0.20+8\bin;J:\codex-work\.toolchains\android-sdk\platform-tools;$env:PATH"
...
foreach ($abi in @("arm64-v8a","x86_64")) {
    if ($abi -eq "arm64-v8a") {
        $rust="aarch64-linux-android"; $bindgen="aarch64-linux-android"; $triplet="arm64-android"; $flutter="android-arm64"
    } else {
        $rust="x86_64-linux-android"; $bindgen="x86_64-linux-android"; $triplet="x64-android"; $flutter="android-x64"
    }
    ...
    cargo ndk --platform 23 --target $rust --output-dir "flutter\android\app\src\main\jniLibs" build --lib --release --features flutter,use_dasp,mediacodec 2>&1 | Select-Object -Last 5

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Note", "備註"),
        ("Connection", "連線"),
        ("Connect to a device by ID or IP", "??ID?IP????"),
        ("Connection & identity", "?????"),
        ("Share screen", "螢幕分享"),
        ("Chat", "聊天"),
        ("Total", "總計"),
        ...
        ("Sort by", "排序方式"),
        ("New Connection", "新連線"),
        ("Join Session", "\u{52a0}\u{5165}\u{5de5}\u{4f5c}\u{968e}\u{6bb5}"),
        ("Public IP:port", "\u{516c}\u{7db2} IP:\u{9023}\u{63a5}\u{57e0}"),
        ("LAN IP:port", "\u{5167}\u{7db2} IP:\u{9023}\u{63a5}\u{57e0}"),
        ("Show Password", "\u{986f}\u{793a}\u{5bc6}\u{78bc}"),
        ("Hide Password", "\u{96b1}\u{85cf}\u{5bc6}\u{78bc}"),
        ("My Identity", "\u{6211}\u{7684}\u{8eab}\u{5206}"),
        ("Quick Actions", "\u{5feb}\u{901f}\u{64cd}\u{4f5c}"),
        ("LUODA Remote Assistance", "LUODA \u{9060}\u{7aef}\u{5354}\u{52a9}"),
        ("Public network", "\u{516c}\u{7db2}"),
        ("Local network", "\u{5167}\u{7db2}"),
        ("VIP features", "VIP \u{529f}\u{80fd}"),
        ("upnp_mapping_ready_tip", "\u{8def}\u{7531}\u{5668}\u{9023}\u{63a5}\u{57e0}\u{6620}\u{5c04}\u{6210}\u{529f}\u{ff0c}\u{516c}\u{7db2}\u{53ef}\u{9054}\u{6027}\u{5c1a}\u{672a}\u{9a57}\u{8b49}\u{3002}"),
        ("upnp_mapping_failed_tip", "\u{9023}\u{63a5}\u{57e0}\u{6620}\u{5c04}\u{5931}\u{6557}\u{ff0c}\u{8acb}\u{624b}\u{52d5}\u{8a2d}\u{5b9a}\u{8def}\u{7531}\u{5668}\u{9023}\u{63a5}\u{57e0}\u{8f49}\u{9001}"),
        ("upnp_mapping_unknown_tip", "\u{9023}\u{63a5}\u{57e0}\u{6620}\u{5c04}\u{72c0}\u{614b}\u{672a}\u{77e5}\u{ff0c}\u{516c}\u{7db2}\u{53ef}\u{9054}\u{6027}\u{5c1a}\u{672a}\u{9a57}\u{8b49}\u{3002}"),
        ("direct_listener_disabled_tip", "IP \u{76f4}\u{63a5}\u{9023}\u{7dda}\u{63a5}\u{807d}\u{670d}\u{52d9}\u{672a}\u{555f}\u{7528}\u{3002}"),
        ("upnp_mapping_unsupported_tip", "\u{76ee}\u{524d}\u{5e73}\u{53f0}\u{4e0d}\u{652f}\u{63f4}\u{81ea}\u{52d5}\u{9023}\u{63a5}\u{57e0}\u{6620}\u{5c04}\u{3002}\u{540c}\u{4e00}\u{7db2}\u{8def}\u{53ef}\u{4f7f}\u{7528}\u{5167}\u{7db2}\u{4f4d}\u{5740}\u{ff0c}\u{5176}\u{4ed6}\u{60c5}\u{6cc1}\u{8acb}\u{4f7f}\u{7528} ID \u{9023}\u{7dda}\u{3002}"),
        ("No visible tabs", "\u{6c92}\u{6709}\u{53ef}\u{898b}\u{5206}\u{9801}"),
        ("Reset all tabs to visible", "\u{91cd}\u{8a2d}\u{70ba}\u{986f}\u{793a}\u{6240}\u{6709}\u{5206}\u{9801}"),
        ("service_card_tip", "\u{63a7}\u{5236}\u{672c}\u{88dd}\u{7f6e}\u{662f}\u{5426}\u{63a5}\u{53d7}\u{9060}\u{7aef}\u{9023}\u{7dda}"),
        ("theme_card_tip", "\u{9078}\u{64c7} LUODA \u{7684}\u{4ecb}\u{9762}\u{5916}\u{89c0}"),
        ("language_card_tip", "\u{9078}\u{64c7}\u{4ecb}\u{9762}\u{986f}\u{793a}\u{8a9e}\u{8a00}"),
        ("recording_card_tip", "\u{8a2d}\u{5b9a}\u{81ea}\u{52d5}\u{9304}\u{5f71}\u{8207}\u{9304}\u{5f71}\u{5132}\u{5b58}\u{4f4d}\u{7f6e}"),
        ("permissions_card_tip", "\u{9078}\u{64c7}\u{9060}\u{7aef}\u{5de5}\u{4f5c}\u{968e}\u{6bb5}\u{53ef}\u{5b58}\u{53d6}\u{7684}\u{672c}\u{6a5f}\u{529f}\u{80fd}"),
        ("password_card_tip", "\u{8a2d}\u{5b9a}\u{4e00}\u{6b21}\u{6027}\u{5bc6}\u{78bc}\u{8207}\u{6c38}\u{4e45}\u{5bc6}\u{78bc}"),
        ("two_factor_card_tip", "\u{70ba}\u{5e33}\u{6236}\u{5b58}\u{53d6}\u{589e}\u{52a0}\u{7b2c}\u{4e8c}\u{5c64}\u{9a57}\u{8b49}"),
        ("device_id_card_tip", "\u{7ba1}\u{7406}\u{7528}\u{65bc}\u{8b58}\u{5225}\u{672c}\u{88dd}\u{7f6e}\u{7684} ID"),
        ("Unlock", "\u{89e3}\u{9396}"),
        ("Restore", "還原"),
        ("Minimize", "最小化"),
        ("Maximize", "最大化"),
        ("Your Device", "您的裝置"),
        ...
        ("Token TTL", "連結有效期"),
        ("Kick Viewer", "請離觀看者"),
        ("Promote Viewer", "提升為協作"),
        ("Raise Hand", "舉手"),
        ("Lower Hand", "放下手"),
        ("Viewer List", "參與者列表"),
        ("Shared Chat", "共享聊天"),
        ("One Shot", "一次性"),
        ("Broadcast Chat Hint", "向所有觀看者廣播訊息..."),
        ("Messages below sent from", "以下訊息發自"),
        ("Messages above sent from", "以上訊息發自"),
        ("PC terminal", "PC端"),
        ("Mobile terminal", "手機端"),
        ("ID connection", "ID連線"),
        ("LAN IP", "局域網IP"),
        ("Public IP", "公網IP"),
        ("Bluetooth connection", "藍牙連線"),
        ("Linked devices", "關聯裝置"),
        ("Please turn on Bluetooth", "請先開啟藍牙"),
        ("Bluetooth scan permission required", "需要藍牙掃描權限"),
        ("Bluetooth connection permission required", "需要藍牙連線權限"),
        ("Failed to send file", "傳送檔案失敗"),
        ("IP connection", "IP連線"),
        ("Source not recorded", "來源未記錄"),
    ].iter().cloned().collect();
}

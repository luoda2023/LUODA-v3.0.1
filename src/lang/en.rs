...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the dotchat network..."),
 ...
 ("Ultra HD", "Ultra HD"),
        ...
        ("install_tip", "Due to UAC, dotchat can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install dotchat to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant dotchat \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant dotchat \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow dotchat to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [dotchat Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next dotchat application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
 ...
 ("Shutting down remote device", "Shutting down remote device"),
 ("remote_shutdown_tip", "Remote device is shutting down, please close this message box"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant dotchat \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant dotchat \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running dotchat."),
        ...
        ("LUODA Remote Assistance", "dotchat remote assistance"),
        ...
        ("theme_card_tip", "Choose the appearance used across dotchat."),
        ...
        ("Meetings", "Meetings"),
        ("People", "people"),
        ("Tap create to start one", "Tap create to start one"),
        ("Create a meeting to chat, share files and watch demos together", "Create a meeting to chat, share files and watch demos together"),
        ...
        ("verify_luoda_password_tip", "Verify dotchat password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use dotchat and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_luoda_server_pro_to_{}_tip", "Please upgrade dotchat Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent dotchat from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by dotchat"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if dotchat window is open"),
...
("poor_network_voice_call_tip", "Network quality is poor. Voice call is not recommended."),
("very_poor_network_hangup_tip", "Network quality is very poor. Consider ending the call."),
        ...
        ("floating_window_tip", "It helps to keep dotchat background service"),
        ...
        ("upgrade_remote_luoda_client_to_{}_tip", "Please upgrade the dotchat client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, dotchat verifies the server certificate for protocols using TLS.\nWith this option enabled, dotchat will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, dotchat will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: dotchat server OSS doesn't include this feature."),
        ...
        ("Map service quota exhausted, place name temporarily unavailable",
            "Map service quota exhausted, place name temporarily unavailable"),
        ("Cached place name, tap to refresh", "Cached place name, tap to refresh"),
        ("Refresh place name", "Refresh place name"),
...
("Host is sharing screen - tap to view", "Host is sharing screen - tap to view"),
        ...
        ("This conversation is E2EE encrypted - no one else can read or view these messages.", "This conversation is E2EE encrypted - no one else can read or view these messages."),
        ("Background updated", "Background updated"),
        ("Botchat BG", "Botchat BG"),
        ("Botchat BG 2", "Botchat BG 2"),
        ("Chat background", "Chat background"),
        ("Recommend to contacts", "Recommend to contacts"),
        ("No contacts to recommend to", "No contacts to recommend to"),
        ("Remote session connecting... Tap the voice button once connected.", "Remote session connecting... Tap the voice button once connected."),
        ("Switch to keyboard", "Switch to keyboard"),
        ("messages", "messages"),
...
("Meeting", "Meeting"),
    ...
    ("Search meetings", "Search meetings"),
        ...
        ("Play a tone or vibrate when a new message arrives", "Play a tone or vibrate when a new message arrives"),
        ...
        ("Vibration duration", "Vibration duration"),
        ("Short vibration", "Short vibration"),
        ("Medium vibration", "Medium vibration"),
        ("Long vibration", "Long vibration"),
        ("Choose audio file", "Choose audio file"),
        ("Choose", "Choose"),
        ("Preview", "Preview"),
        ("Tone Crisp", "Crisp"),
        ("Tone Soft", "Soft"),
        ("Tone Electronic", "Electronic"),
        ("Tone Droplet", "Droplet"),
        ("Tone Triple", "Triple"),

...
function Do-Ocr($path) {
    ...
    foreach ($line in $result.Lines) {
        ...
        if ($line.Words.Count -gt 0) {
            ...
            Write-Output ("  " + $r.Y.ToString() + "," + $r.X.ToString() + " H=" + $r.Height.ToString() + "  " + $words)
        }
    }
}
Write-Output '=== TOP ==='; Do-Ocr 'J:\codex-work\LUODA-v3.0.1\flutter\crop_top.png'
Write-Output '=== MID ==='; Do-Ocr 'J:\codex-work\LUODA-v3.0.1\flutter\crop_mid.png'

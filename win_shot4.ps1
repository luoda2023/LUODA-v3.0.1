...
"@
$w=2048; $h=1280
$desk=[Cap2]::GetDesktopWindow()
$dc=[Cap2]::GetWindowDC($desk)
$cdc=[Cap2]::CreateCompatibleDC($dc)
$bmp=[Cap2]::CreateCompatibleBitmap($dc,$w,$h)
$old=[Cap2]::SelectObject($cdc,$bmp)
[Cap2]::BitBlt($cdc,0,0,$w,$h,$dc,0,0,0x00CC0020)|Out-Null
...
[Cap2]::SelectObject($cdc,$old)|Out-Null
[Cap2]::DeleteObject($bmp)|Out-Null
[Cap2]::DeleteDC($cdc)|Out-Null
[Cap2]::ReleaseDC($desk,$dc)|Out-Null
$img.Dispose()

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Public IP:port", ""),
        ("LAN IP:port", ""),
        ("Messages below sent from", ""),
        ("Messages above sent from", ""),
        ("PC terminal", ""),
        ("Mobile terminal", ""),
        ("Unknown device", ""),
        ("ID connection", ""),
        ...
        ("Bluetooth connection permission required", ""),
        ("Failed to send file", ""),
        ("IP connection", ""),
        ("Source not recorded", ""),
        ("Show Password", ""),
        ...
        ("Destroy", ""),
        ("Destroy message", ""),
        ("Destroy message on both devices?", ""),
        ("Message recalled", ""),
        ("Message destroyed", ""),

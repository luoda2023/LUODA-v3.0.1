...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
 ...
 ("Connecting via relay server...", "正在通过中继服务器连接..."),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 点聊 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 点聊 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 点聊 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 点聊 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [点聊 Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep LUODA background service", "保持点聊后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 点聊 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
 ...
 ("Are you sure you want to shutdown", "确定要关机"),
 ("Shutting down remote device", "正在关闭远程设备"),
 ("remote_shutdown_tip", "远程设备正在关机, 请关闭当前提示框"),
        ("Copied", "已复制"),
        ...
        ("Clear", "清空"),
        ("clear_history_tip", "确定要清空全部访问历史吗？此操作不可恢复。"),
        ("Cleared", "已清空"),
        ("No offline history to clear", "没有可清空的离线历史"),
        ("Unknown", "未知"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 点聊 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 点聊 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 点聊 的 UAC 窗口点击确认。"),
        ...
        ("My Identity", "我的身份"),
        ("Quick Actions", "快捷操作"),
        ("LUODA Remote Assistance", "点聊远程协助"),
        ("Public network", "公网"),
        ("Local network", "内网"),
        ("VIP features", "VIP 功能"),
        ...
        ("verify_luoda_password_tip", "验证 点聊 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 点聊 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("No displays", "未检测到显示器。请以管理员身份重新运行 点聊 以完成虚拟显示驱动的首次安装，然后重新连接。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，点聊 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 点聊 窗口打开时允许连接"),
...
("Calling...", "呼叫中..."),
("fair_network_voice_call_tip", "网络质量一般，通话可能会有卡顿。"),
("poor_network_voice_call_tip", "网络质量较差，不建议使用语音通话。"),
("very_poor_network_hangup_tip", "网络质量很差，建议结束通话。"),
        ("texture_render_tip", "使用纹理渲染，使图片更加流畅。 如果您遭遇渲染问题，可尝试关闭此选项。"),
        ("Use texture rendering", "使用纹理渲染"),
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持点聊后台服务"),
        ...
        ("upgrade_remote_luoda_client_to_{}_tip", "请在远程端将 点聊 客户端升级至版本 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，点聊 会验证服务器证书。\n启用此选项后，在验证失败时，点聊 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否仅使用 TCP。\n启用此选项后，点聊 将不再使用 UDP 23116，而是使用 TCP 23116。"),
        ("server-oss-not-support-tip", "注意：点聊 开源服务器 (OSS server) 不包含此功能。"),
        ...
        ("Available when LUODA is running", "点聊 运行时可接收"),
        ("Device ID", "设备ID"),
        ...
        ("Sent", "已发送"),
        ("Delivered", "已送达"),
        ("Available when DotChat is running", "点聊运行时可接收"),
        ...
        ("LAN IP", "局域网IP"),
        ("Public IP", "公网IP"),
        ("Connection mode", "当前连接方式"),
        ("relay_last_resort_tip", "优先点对点直连（P2P）；中继仅在打洞失败时作为最后手段使用，聊天内容不经过服务器中转留存。"),
        ...
        ("Enable input control in system settings, then return to DotChat.", "请在系统设置中开启输入控制，然后返回点聊。"),
        ...
        ("Scan with DotChat on the phone. Pairing data stays on both devices.", "请使用手机端点聊扫码。绑定数据仅保存在两台设备上。"),
        ("Bound phone", "已绑定手机"),
        ("Bound PC", "已绑定电脑"),
        ("Device", "设备"),
        ("Bound at", "绑定时间"),
        ...
        ("DotChat stores the name, avatar, contacts, and pairing data on this device only.", "点聊仅在本机保存名称、头像、联系人和绑定数据。"),
...
("Host is sharing screen - tap to view", "主持人正在共享屏幕 - 点击观看"),
        ...
        ("Failed to start voice call.", "无法开始语音通话。"),
        ("Failed to stop voice call.", "无法结束语音通话。"),
        ("Failed to switch to voice call.", "无法切换到语音通话。"),
        ("Failed to switch out voice call.", "无法退出语音通话。"),
        ("Voice Call Request", "语音通话请求"),
        ("Do you accept?", "是否接受？"),
        ("Closed manually by the peer", "对方已结束语音通话"),
    ...
    ("File access", "文件访问"),
        ...
        ("max_viewers", "最大观看人数"),
        ("messages", "条消息"),
        ("upgrade_luoda_server_pro_to_{1.1.10}_tip", "请将 点聊 Server Pro 升级到 1.1.10 或更高版本！"),
        ("viewer_ttl", "邀请有效期"),
        ("Group Settings", "群聊设置"),
        ("Group settings", "群聊设置"),
        ("Image Settings", "图像设置"),
        ...
        ("This conversation is E2EE encrypted - no one else can read or view these messages.", "此对话已端到端加密，其他人无法查看这些消息。"),
        ("Background updated", "背景已更新"),
        ("Botchat BG", "点聊背景"),
        ("Botchat BG 2", "点聊背景 2"),
        ("Chat background", "聊天背景"),
        ("Recommend to contacts", "推荐给联系人"),
        ("No contacts to recommend to", "暂无联系人可推荐"),
        ("Remote session connecting... Tap the voice button once connected.", "远程会话连接中…连接成功后点击语音按钮。"),
        ...
        ("Important", "重要"),
        ("Screen sharing (remote assist)", "屏幕共享（远程协助）"),
        ("Auto-start screen sharing", "启动时自动开启屏幕共享"),
        ("Auto start the share service on app launch (shows the system record/project dialog)", "开启后，每次打开软件会自动启动共享服务（会弹出系统的“要开始录制或投射内容吗？”授权框）。关闭则需手动在协助页启动，平时不弹窗。"),
        ("Screen sharing will auto start on next launch", "下次启动软件时将自动开启屏幕共享"),
        ("Screen sharing will not auto start", "已关闭自动开启，需要远程协助时请手动启动"),
        ("Waiting for phone scan... The dialog closes automatically after pairing.", "等待手机扫码…绑定成功后此窗口将自动关闭。"),
        ("Voice reading", "语音朗读"),
        ("Read new messages aloud", "新消息自动朗读"),
        ("Offline voice reading via local model; no server involved", "完全离线本地朗读，不经过任何服务器"),
        ("Reading voice", "朗读声音"),
        ("Model not downloaded yet", "语音模型尚未下载"),
        ("Reading speed", "朗读语速"),
        ("Delete voice model", "删除语音模型"),
        ("Free up about 133 MB of storage", "释放约 133 MB 存储空间"),
        ("Downloading voice model…", "正在下载语音模型…"),
        ("Download voice model (about 133 MB)", "下载语音模型（约 133 MB）"),
        ("One-time download, then fully offline reading", "一次下载，之后完全离线朗读"),
        ("Voice model ready", "语音模型已就绪"),
        ("Voice model download failed, please retry", "语音模型下载失败，请重试"),
        ("Download started, please wait", "已开始下载，请稍候"),
        ("This removes the offline voice model (about 133 MB). Reading aloud will stop until you download it again.", "此操作将删除离线语音模型（约 133 MB）。删除后需重新下载才能继续朗读。"),
        ("Voice model deleted", "语音模型已删除"),
        ("女声 1", "女声 1"),
        ("女声 2", "女声 2"),
        ("男声 1", "男声 1"),
        ("男声 2", "男声 2"),
        ("女声 3", "女声 3"),
        // TTS UI strings
        ("Auto-read incoming text messages when enabled", "开启后自动朗读收到的文本消息"),
        ("Automatically read all incoming messages one by one until turned off", "自动逐条朗读所有收到的消息，直到关闭"),
        ("Bundled model (about 133 MB)", "内置模型（约 133 MB）"),
        ("Continuous reading", "连续朗读"),
        ("Copying voice model…", "正在复制语音模型…"),
        ("Engine idle timeout", "引擎空闲超时"),
        ("Long-press any text message to read it aloud", "长按任意文本消息即可朗读"),
        ("Never auto-release", "永不自动释放"),
        ("Reading aloud…", "正在朗读…"),
